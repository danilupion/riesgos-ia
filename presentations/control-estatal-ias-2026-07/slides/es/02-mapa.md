...
<!--
Bloque 2: El mapa (~7 min). Tres campos, crux IAPS (momento interactivo 1),
gradiente de acceso, quién decide. Fuente: crossover §0, §1, §6.
-->

# Bloque 2
## El mapa: dónde estamos

<!--
VOZ:
"Los hechos ya los tenemos. Ahora el mapa: ¿dónde cae esto en el espacio de
estrategias que la comunidad de AI safety lleva años dibujando?"
...
<div class="max-w-6xl mx-auto px-8 pt-2">
  <div class="text-sm uppercase tracking-widest opacity-60 mb-3" style="font-family: 'Montserrat', sans-serif; letter-spacing: 0.15em">
    Las estrategias frente a la AGI
  </div>
  ...
  <div class="grid grid-cols-3 gap-5">
    ...
    <div class="p-5 rounded-lg" style="background: rgba(148, 163, 184, 0.06); border-top: 4px solid #94a3b8">
      <div class="text-base font-bold mb-2 opacity-80" style="font-family: 'Saira Condensed', sans-serif">3 · DEFENSAS + DIFUSIÓN</div>
      <div class="text-sm leading-relaxed opacity-70" style="font-family: 'Montserrat', sans-serif">
        Acelerar la defensa, difundir capacidades, desconfiar de los centros de poder.
      </div>
    </div>
  </div>
...
<!--
VOZ:
"Antes de seguir, os pregunto. Esta es la pregunta que el informe de IAPS
identifica como EL crux de toda la gobernanza de IA: ¿qué os preocupa más,
...
- Apuntar la proporción; se retoma en la siguiente y en Q&A.
- ~1.5-2 min.
-->
...
acercándose a la frontera que nadie puede retirar. Los dos males del crux a
la vez. El peor de los dos mundos, como experimento natural."

NOTAS:
- Enlazar con lo votado: "los que temíais X: lo tenéis. Los que temíais Y:
  también."
- La parte open-weight se demuestra en Bloque 3.
- ~1 min.
-->
...
<div class="max-w-6xl mx-auto px-8 pt-2">
  ...
  <div class="grid grid-cols-4 gap-3 text-center">
    <div class="p-4 rounded-lg" style="background: rgba(255, 148, 22, 0.15)">
      <div class="text-sm font-bold" style="color: #ff9416; font-family: 'Saira Condensed', sans-serif">SIN SALVAGUARDAS</div>
      <div class="text-xs mt-2 opacity-80" style="font-family: 'Montserrat', sans-serif">Versión interna «helpful-only».</div>
    </div>
    <div class="p-4 rounded-lg" style="background: rgba(255, 148, 22, 0.10)">
      <div class="text-sm font-bold" style="color: #ff9416; font-family: 'Saira Condensed', sans-serif">APROBADOS</div>
      <div class="text-xs mt-2 opacity-80" style="font-family: 'Montserrat', sans-serif">Mythos 5. ~100 organizaciones, por carta.</div>
    </div>
    <div class="p-4 rounded-lg" style="background: rgba(255, 148, 22, 0.05)">
      <div class="text-sm font-bold" style="color: #ff9416; font-family: 'Saira Condensed', sans-serif">PÚBLICO</div>
  ...
  <div v-click class="mt-8">
    <div class="p-5 rounded-lg" style="background: rgba(148, 163, 184, 0.08)">
      <blockquote class="text-base italic" style="font-family: 'Roboto Slab', serif">
        «Los empleados acceden a modelos "helpful-only" con pocas salvaguardas; meses después, el público accede a versiones más restringidas.»
      </blockquote>
...
- Original: "employees get access to 'helpful-only' models with few safety
  guardrails, and after some months, the public gets access to more
  restricted versions" (Forethought, verificado en crossover §1).
- ~1.5 min.
-->
...
<div class="max-w-6xl mx-auto px-8 pt-2">
  <div class="text-4xl font-bold mb-8" style="font-family: 'Saira Condensed', sans-serif; color: #ff9416">
    ¿Quién decide quién es de fiar?
  </div>
  <div class="space-y-5">
    <div class="p-5 rounded-lg" style="background: rgba(148, 163, 184, 0.08)">
      <blockquote class="text-base italic" style="font-family: 'Roboto Slab', serif">
        «Todo esfuerzo por encima de cierto umbral de capacidad deberá someterse a
        <span class="font-semibold" style="color:#ff9416">una autoridad internacional</span>.»
      </blockquote>
      <div class="text-sm opacity-50 mt-2" style="font-family: 'Montserrat', sans-serif">Altman, Brockman y Sutskever (OpenAI, 2023)</div>
    </div>
...
<!--
VOZ:
"Y la pregunta filosófica del bloque. En 2023, los fundadores de OpenAI
pedían que todo esfuerzo por encima de un umbral de capacidad se sometiera
a una autoridad internacional. Dos niveles más autoridad. Era su propuesta.

Lo que ha llegado tiene los dos niveles. Pero la autoridad es un solo
gobierno, el criterio de Glasswing nunca se ha publicado, y la lista de
aprobados viaja en una carta del secretario de Comercio.

[CLICK]

¿Quién vigila a los vigilantes? No es retórica: es la diferencia entre
poder con reglas públicas y poder arbitrario. Una 'organización aprobada'
sin criterio publicado no es una categoría regulatoria. Es un privilegio."

NOTAS:
- Original: "any effort above a certain capability threshold will need to
  be subject to an international authority" (OpenAI 2023, verificado).
- Transición a Bloque 3: "¿Y el fundamento técnico de ese poder?"
- ~1.5 min. Total bloque: ~7 min.
-->
