...
<!--
Block 2: The map (~7 min). Three camps, IAPS crux (interactive moment 1),
access gradient, who decides. Source: crossover §0, §1, §6.
-->
...
<!--
VOICE:
"We have the facts. Now the map: where does this fall in the space of
strategies the AI safety community has been sketching for years?"
...
<div class="max-w-6xl mx-auto px-8 pt-2">
  ...
  <div class="grid grid-cols-3 gap-5">
    ...
    <div class="p-5 rounded-lg" style="background: rgba(148, 163, 184, 0.06); border-top: 4px solid #94a3b8">
      <div class="text-base font-bold mb-2 opacity-80" style="font-family: 'Saira Condensed', sans-serif">3 · DEFENSES + DIFFUSION</div>
      <div class="text-sm leading-relaxed opacity-70" style="font-family: 'Montserrat', sans-serif">
        Accelerate defense, diffuse capabilities, distrust centers of power.
      </div>
    </div>
  </div>
...
<!--
VOICE:
"Before we go on, a question for you. This is the question the IAPS report
identifies as THE crux of all AI governance: which worries you more, power
...
models approaching the frontier that nobody can recall. Both evils of the
crux at once. The worst of both worlds, as a natural experiment."

NOTES:
- Tie back to the vote: "those who feared X: you have it. Those who feared
  Y: you have it too."
- The open-weight part is demonstrated in Block 3.
- ~1 min.
-->
...
<div class="max-w-6xl mx-auto px-8 pt-2">
  ...
  <div class="grid grid-cols-4 gap-3 text-center">
    <div class="p-4 rounded-lg" style="background: rgba(255, 148, 22, 0.15)">
      <div class="text-sm font-bold" style="color: #ff9416; font-family: 'Saira Condensed', sans-serif">NO SAFEGUARDS</div>
      <div class="text-xs mt-2 opacity-80" style="font-family: 'Montserrat', sans-serif">Internal "helpful-only" version.</div>
    </div>
    <div class="p-4 rounded-lg" style="background: rgba(255, 148, 22, 0.10)">
      <div class="text-sm font-bold" style="color: #ff9416; font-family: 'Saira Condensed', sans-serif">APPROVED</div>
      <div class="text-xs mt-2 opacity-80" style="font-family: 'Montserrat', sans-serif">Mythos 5. ~100 organizations, by letter.</div>
    </div>
    <div class="p-4 rounded-lg" style="background: rgba(255, 148, 22, 0.05)">
      <div class="text-sm font-bold" style="color: #ff9416; font-family: 'Saira Condensed', sans-serif">PUBLIC</div>
  ...
  <div v-click class="mt-8">
    <div class="p-5 rounded-lg" style="background: rgba(148, 163, 184, 0.08)">
      <blockquote class="text-base italic" style="font-family: 'Roboto Slab', serif">
        "Employees get access to 'helpful-only' models with few safety guardrails, and after some months, the public gets access to more restricted versions."
      </blockquote>
...
<div class="max-w-6xl mx-auto px-8 pt-2">
  ...
  <div class="space-y-5">
    <div class="p-5 rounded-lg" style="background: rgba(148, 163, 184, 0.08)">
      <blockquote class="text-base italic" style="font-family: 'Roboto Slab', serif">
        "Any effort above a certain capability threshold will need to be subject to
        <span class="font-semibold" style="color:#ff9416">an international authority</span>."
      </blockquote>
      <div class="text-sm opacity-50 mt-2" style="font-family: 'Montserrat', sans-serif">Altman, Brockman and Sutskever (OpenAI, 2023)</div>
    </div>
...
<!--
VOICE:
"And the block's philosophical question. In 2023, OpenAI's founders asked
that any effort above a capability threshold be subject to an international
authority. Two tiers plus an authority. It was their proposal.

What has arrived has the two tiers. But the authority is a single
government, the Glasswing criterion has never been published, and the list
of approved organizations travels in a letter from the Secretary of
Commerce.

[CLICK]

Who watches the watchmen? This is not rhetoric: it is the difference
between power with public rules and arbitrary power. An 'approved
organization' without a published criterion is not a regulatory category.
It is a privilege."

NOTES:
- Quote verbatim (verified): OpenAI 2023.
- Transition to Block 3: "And the technical foundation of that power?"
- ~1.5 min. Block total: ~7 min.
-->
